...
use Ym\AliyunSls\Request\GetLogsRequest;
use Ym\AliyunSls\Response\GetLogsResponse;
...
class Client implements ClientInterface
{
     ...
     */
    public function getLogs($project = null, $logstore = null, $from = null, $to = null, $topic = null, $query = '*', $line = 50, $offset = 0, $reverse = true) {
        $to = $to?:time();
